CREATE OR REPLACE FUNCTION sync_location_coordinate_columns()
RETURNS trigger
LANGUAGE plpgsql
AS $$
BEGIN
...
DROP TRIGGER IF EXISTS trg_sync_location_coordinate_columns ON locations;

CREATE TRIGGER trg_sync_location_coordinate_columns
BEFORE INSERT OR UPDATE ON locations
FOR EACH ROW
EXECUTE FUNCTION sync_location_coordinate_columns();
