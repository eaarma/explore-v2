...
export type AdminLocationCreateColors = ReturnType<
  typeof getAdminLocationCreateColors
>;
export type AdminLocationCreateStyles = ReturnType<
  typeof createAdminLocationCreateStyles
>;

export function getAdminLocationCreateColors(isDark: boolean) {
  if (isDark) {
    return {
      background: "#020617",
      surface: "#0F172A",
...
export function createAdminLocationCreateStyles(
