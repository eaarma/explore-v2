...
export type AdminJourneyDetailsColors = ReturnType<
  typeof getAdminJourneyDetailsColors
>;
export type AdminJourneyDetailsStyles = ReturnType<
  typeof createAdminJourneyDetailsStyles
>;

export function getAdminJourneyDetailsColors(isDark: boolean) {
...
export function createAdminJourneyDetailsStyles(
