import { type UpdateAdminJourneyRequest } from "@/src/features/admin/api/adminJourneysApi";
import { formatRouteDistance, normalizeCategory } from "@/src/features/journeys/components/journeysSectionShared";
...
export function parseJourneyId(value: string | string[] | undefined) {
  if (!value) {
    return null;
  }
...
export function createJourneyEditDraft(journey: Journey): JourneyEditDraft {
  return {
    title: journey.title ?? "",
...
export function buildJourneyUpdatePayload(
...
export function mergeJourneyForAdminView(
...
export function reconcileCachedJourneysAfterAdminSave(
...
export function reconcileCachedJourneyLocationsAfterAdminSave(
...
export function getJourneyTitle(title: string | null | undefined) {
...
export function getJourneyDescription(description: string | null | undefined) {
...
export function getRawValue(value: string | null | undefined) {
...
export function getMultilineValue(
  value: unknown,
...
export function normalizeTraitList(traits: string[] | JourneyTrait[] | undefined) {
