...
export type AdminJourneyCreateColors = ReturnType<
  typeof getAdminJourneyCreateColors
>;
export type AdminJourneyCreateStyles = ReturnType<
  typeof createAdminJourneyCreateStyles
>;

export function getAdminJourneyCreateColors(isDark: boolean) {
  if (isDark) {
    return {
      background: "#020617",
      surface: "#0F172A",
...
export function createAdminJourneyCreateStyles(
