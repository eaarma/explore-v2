...
import {
  type AdminLocationCreateColors,
...
type AdminLocationCreateCoordinatePickerModalProps = {
  visible: boolean;
...
export function AdminLocationCreateCoordinatePickerModal({
  visible,
  initialCoordinates,
  colors,
  onClose,
  onConfirm,
}: AdminLocationCreateCoordinatePickerModalProps) {
  ...
  const styles = useMemo(() => createAdminLocationCreateStyles(colors), [colors]);
      ...
      <View style={styles.modalContainer}>
        ...
        <View style={styles.mapFrame}>
          ...
          >
            ...
            <GeoJSONSource id="admin-location-create-picker-point" data={markerGeoJson}>
              <Layer
                id="admin-location-create-picker-glow"
                type="circle"
                paint={{
                  "circle-radius": 16,
              ...
              />
              <Layer
                id="admin-location-create-picker-dot"
                type="circle"
                paint={{
                  "circle-radius": 7,
                  "circle-color": colors.accent,
