...
export const LEGAL_DOCUMENT_LAST_UPDATED_LABEL = "May 31, 2026";
export const PRIVACY_POLICY_VERSION = "2026-05-31";
export const TERMS_VERSION = "2026-05-31";

type LegalDocumentVariables = {
  appTitle?: string | null;
  contactEmail?: string | null;
};

export function buildPrivacyPolicyDocument({
  appTitle,
  contactEmail,
}: LegalDocumentVariables): SettingsDocument {
  const resolvedAppTitle = resolveAppTitle(appTitle);
  const resolvedContactEmail = resolveContactEmail(contactEmail);

  return {
    eyebrow: "Policy",
    title: "Privacy policy",
    description: `Last updated: ${LEGAL_DOCUMENT_LAST_UPDATED_LABEL}`,
    sections: [
      {
        title: "Overview",
        body: `${resolvedAppTitle} ("the App") is a location-based exploration application that helps users discover locations, complete journeys, and track exploration progress.`,
      },
      {
  ...
  return {
    ...
    sections: [
      ...
      },
      {
        ...
        body: `Users participate entirely at their own risk.\n\n${resolvedAppTitle} is not responsible for injuries, losses, damages, accidents, or other consequences resulting from visits to locations displayed within the App.`,
      },
      {
      ...
      },
      {
        ...
        body: `By submitting content, users grant ${resolvedAppTitle} a non-exclusive license to store, display, and use that content for operation of the service.\n\nUsers remain responsible for ensuring they have the necessary rights to any submitted content.\n\n${resolvedAppTitle} does not guarantee the accuracy, legality, completeness, or suitability of user-submitted content.`,
      },
      {
        title: "9. Content Moderation",
        body: `${resolvedAppTitle} may remove, edit, restrict, or reject content at its discretion.\n\nAccounts may be suspended or terminated for violations of these Terms.`,
      },
      {
        title: "10. Intellectual Property",
        body: `The App, its design, branding, and original content are owned by ${resolvedAppTitle} or its licensors.\n\nUsers may not copy, redistribute, or commercially exploit App content without permission unless otherwise permitted by law.`,
      },
      {
        title: "11. Service Availability",
        body: `${resolvedAppTitle} is provided on an "as available" basis.\n\nWe do not guarantee:`,
        items: [
      ...
      },
      {
        ...
        body: `To the maximum extent permitted by law, ${resolvedAppTitle} and its operators shall not be liable for:`,
        items: [
          "Personal injury",
          "Property damage",
          "Lost profits",
      ...
      },
      {
        ...
        body: `${resolvedAppTitle} may suspend or terminate accounts for:`,
        items: [
